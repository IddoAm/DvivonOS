...
static const keycode_t sc1_to_keycode[128] = {
    /*00*/ KC_NONE, KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINUS, KC_EQUAL, KC_BSPC, KC_TAB,
    /*10*/ KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBR, KC_RBR, KC_ENTER, KC_LCTRL, KC_A, KC_S,
    /*20*/ KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SEMI, KC_APOS, KC_GRAVE, KC_LSHIFT, KC_BSLASH, KC_Z, KC_X, KC_C, KC_V,
    /*30*/ KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, KC_RSHIFT, KC_KP_STAR, KC_LALT, KC_SPACE, KC_CAPS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,
    /*40*/ KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE,
    /*50*/ KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE,
